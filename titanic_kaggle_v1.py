...
#### Build the models
rf_est = ensemble.RandomForestClassifier(n_estimators = 500, min_samples_split = 4, max_depth =  10, max_features = 80, n_jobs = 10, random_state = 42)
gbm_est = ensemble.GradientBoostingClassifier(n_estimators = 500, learning_rate = 0.085, max_depth = 5, max_features =50, random_state = 42)
ada_est = ensemble.AdaBoostClassifier(n_estimators = 500, learning_rate = 1, random_state = 42)
bag_est = ensemble.BaggingClassifier(n_estimators = 700, max_samples =150, max_features = 50, n_jobs =10, random_state = 42)
et_est = ensemble.ExtraTreesClassifier(n_estimators =500, max_depth =10, max_features =50, n_jobs =10, random_state = 42)

...
def fill_missing_age(missing_age_train, missing_age_test):
    ...
    ada_reg_param_grid = {'learning_rate': [0.2], 'n_estimators': [2000]}
    ada_reg_grid = model_selection.GridSearchCV(ada_reg, ada_reg_param_grid, cv = 10, n_jobs = 15, verbose = 1, scoring = 'neg_mean_squared_error')
    ...
    rf_reg_param_grid = {'n_estimators': [2000], 'max_depth': [3], 'max_features': [3]}
    rf_reg_grid = model_selection.GridSearchCV(rf_reg, rf_reg_param_grid, cv = 10, n_jobs = 15, verbose = 1, scoring = 'neg_mean_squared_error')
...
#### Build the models
rf_est = ensemble.RandomForestClassifier(n_estimators = 1000, max_features = 150, min_samples_split = 4, max_depth =  20, n_jobs = 15, random_state = 2017, verbose = 1)
gbm_est = ensemble.GradientBoostingClassifier(n_estimators = 1000, learning_rate = 0.05, max_depth = 3,  random_state = 2017, verbose = 1)
ada_est = ensemble.AdaBoostClassifier(n_estimators = 1000, learning_rate = 0.5, random_state = 2017)
et_est = ensemble.ExtraTreesClassifier(n_estimators = 1000, max_depth = 20,  n_jobs = 15, random_state = 2017, verbose = 1)
xgb_est = XGBClassifier(n_estimators = 1000, max_depth = 2, eta = 0.05, n_jobs = 15, random_state = 2017)

...
def fill_missing_age(missing_age_train, missing_age_test):
    ...
    gbm_reg_param_grid = {'n_estimators': [2500], 'max_depth': [3], 'learning_rate': [0.1], 'max_features': [3]}
...
def top_n_features(df_X, df_y, top_n):
    ...
    rf_param_grid = {'n_estimators' : [1000], 'min_samples_split':[3], 'max_depth':[20], 'criterion':['entropy'], 'max_features': [60]}
...
#### Build the models
rf_est = ensemble.RandomForestClassifier(n_estimators = 2500, min_samples_split = 4, max_depth =  10, max_features = 80, n_jobs = 10, random_state = 42)
gbm_est = ensemble.GradientBoostingClassifier(n_estimators = 2500, learning_rate = 0.1, max_depth = 5, max_features = 50, random_state = 42)
ada_est = ensemble.AdaBoostClassifier(n_estimators = 2500, learning_rate = 1, random_state = 42)
bag_est = ensemble.BaggingClassifier(n_estimators = 2500, max_samples = 150, max_features = 50, n_jobs = 10, random_state = 42)
et_est = ensemble.ExtraTreesClassifier(n_estimators = 2500, max_depth = 10, max_features = 50, n_jobs = 10, random_state = 42)

xgb_est = XGBClassifier(n_estimators = 2500, max_depth = 4, eta = 0.1, n_jobs = 10, random_state = 42)
